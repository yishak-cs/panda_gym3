            ...
            <div class="card mb-6">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div class="card-body">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <form method="GET" action="{{ route('Members-expiring') }}" class="row g-3" id="filterForm">
                                    <div class="col-12">
                                ...
                                <div class="card-datatable table-responsive">
                                                            ...
                                                            <small class="text-muted">
                                                                ...
                                                                @else
                                                                    @if (abs($diffHours) < 24)
                                                                        Today
                                                                    @else
                                                                        {{ abs($diffHours) }} hours {{ $diffDays > 0 ? 'ago' : 'from now' }}
                                                                    @endif
                                                                @endif
                                                            </small>
                                                        </td>
                                    ...
                                    @else
                                        <div class="text-center py-5">
                                            ...
                                            <p class="text-muted">
                                                No members have subscriptions expiring or expired on {{ request('date', now()->format('Y-m-d')) }}.
                                            </p>
                                        </div>
                                    @endif
                                </div>
