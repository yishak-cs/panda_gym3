                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            Welcome to PandaGym</p>

                                        <!-- Embed QR Code -->
                                        <div style="text-align: center; margin: 20px 0;">
                                            <img src="{{ $message->embedData(
                                                file_get_contents(storage_path('app/public/' . $sub->member->qrCode->path)),
                                                'qr-code.png',
                                            ) }}"
                                                alt="Your QR Code" style="max-width: 100%; height: auto;">
                                        </div>

                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Scan the QR code above at the entrance of the gym to check in.</p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Regards,<br>
                                            {{ ucwords(getenv('APP_NAME')) }}</p>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <p
                                                        ...
                                                        If you're having trouble viewing your QR code, Please report to
                                                        the frontdesk immediately</p>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © {{ date('Y') }} {{ ucwords(getenv('APP_NAME')) }}. All rights
                                            reserved.</p>
